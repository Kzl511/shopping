                      ...
                      <td>
                        <div class="btn-group">
                          ...
                          <div class="delete-container">
                            <a href="product_delete.php?id=<?php echo $value['id'] ?>" type="button" onclick="return confirm('Are you sure you want to delete this post?')" class="btn btn-danger">Delete</a>
                          </div>
                        </div>
                      </td>
                    </tr>
